...
void ControllerSettingsDialog::onNewProfileClicked()
{
  ...
  std::string profile_path(InputManager::GetInputProfilePath(profile_name.toStdString()));
...
void ControllerSettingsDialog::onDeleteProfileClicked()
{
  ...
  std::string profile_path(InputManager::GetInputProfilePath(m_profile_name.toStdString()));
...
void ControllerSettingsDialog::onRestoreDefaultsClicked()
{
  ...
  {
    auto lock = Host::GetSettingsLock();
    InputManager::SetDefaultConfig(*Host::Internal::GetBaseSettingsLayer());
    QtHost::QueueSettingsSave();
  }
...
void ControllerSettingsDialog::switchProfile(const QString& name)
{
  ...
  if (!name.isEmpty())
  {
    std::string path(InputManager::GetInputProfilePath(name.toStdString()));
